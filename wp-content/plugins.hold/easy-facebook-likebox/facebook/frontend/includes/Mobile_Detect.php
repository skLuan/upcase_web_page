	...
	class EFBL_Mobile_Detect {
		...
		public function mobileGrade() {
			...
			if ( // Apple iOS 4-7.0 – Tested on the original iPad (4.3 / 5.0), iPad 2 (4.3 / 5.1 / 6.1), iPad 3 (5.1 / 6.0), iPad Mini (6.1), iPad Retina (7.0), iPhone 3GS (4.3), iPhone 4 (4.3 / 5.1), iPhone 4S (5.1 / 6.0), iPhone 5 (6.0), and iPhone 5S (7.0)
				$this->isIOS() && $this->version( 'iPad', self::VERSION_TYPE_FLOAT ) >= 4.3 || $this->isIOS() && $this->version( 'iPhone', self::VERSION_TYPE_FLOAT ) >= 4.3 || $this->isIOS() && $this->version( 'iPod', self::VERSION_TYPE_FLOAT ) >= 4.3 ||
			...
			if ( $this->isIOS() && $this->version( 'iPad', self::VERSION_TYPE_FLOAT ) < 4.3 || $this->isIOS() && $this->version( 'iPhone', self::VERSION_TYPE_FLOAT ) < 4.3 || $this->isIOS() && $this->version( 'iPod', self::VERSION_TYPE_FLOAT ) < 4.3 ||
			...
			if ( // Blackberry 4.x - Tested on the Curve 8330
				...
				$this->isIOS() && $this->version( 'iPad', self::VERSION_TYPE_FLOAT ) <= 3.2 || $this->isIOS() && $this->version( 'iPhone', self::VERSION_TYPE_FLOAT ) <= 3.2 || $this->isIOS() && $this->version( 'iPod', self::VERSION_TYPE_FLOAT ) <= 3.2 ||
