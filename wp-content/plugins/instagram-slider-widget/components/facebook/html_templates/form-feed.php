...
<div class="wisw-social-content">
	...
	<form action="" method="post" name="wis-feed-add-form" id="wis-feed-add-form">
		...
		<div class="jr-container">
			...
			<div class="isw-tabs">
				<ul>
					<li class="desk_tab active" id="desk_tab_<?= $feed_id ?>"
					    data-tab-id="<?= $feed_id ?>"><?php _e( 'Desktop', 'instagram-slider-widget' ); ?></li>
					<li class="mob_tab" id="mob_tab_<?= $feed_id ?>"
					    data-tab-id="<?= $feed_id ?>"><?php _e( 'Mobile', 'instagram-slider-widget' ); ?></li>
				</ul>
			</div>
