			...
			vc_map(
				array(
					...
					'params'      => array(
						...
						array(
							'type'       => 'colorpicker',
							'param_name' => 'submenu_wide_heading_color',
							'heading'    => __( 'Sub Heading Color on Mega Menu', 'porto-functionality' ),
							'selectors'  => array(
								'#header {{WRAPPER}}.main-menu .wide li.sub > a, {{WRAPPER}} .sidebar-menu .wide li.sub > a, #header {{WRAPPER}}.porto-popup-menu .main-menu .wide li.sub > a' => 'color: {{VALUE}};',
							),
							'group'      => __( 'Menu Popup', 'porto-functionality' ),
						),
						$custom_class,
