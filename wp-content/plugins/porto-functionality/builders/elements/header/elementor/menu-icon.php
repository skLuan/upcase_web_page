		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'raw'             => sprintf( esc_html__( 'Please see %1$sTheme Options -> Header -> Mobile Panel%2$s.', 'porto-functionality' ), '<b>', '</b>' ),
					'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
				)
			);

			$this->add_control(
				'description_mobile_toggle_skin',
				array(
					'type'            => Controls_Manager::RAW_HTML,
					'raw'             => sprintf( esc_html__( 'Please see %1$sTheme Options -> Skin -> Mobile Menu%2$s panel.', 'porto-functionality' ), '<b>', '</b>' ),
					'content_classes' => 'elementor-panel-alert elementor-panel-alert-info',
				)
			);
