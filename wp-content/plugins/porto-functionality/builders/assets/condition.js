...
jQuery( document ).ready( function ( $ ) {
	...
	} ).on( 'click', '#elementor-panel-saver-button-publish, .vcv-ui-navbar-controls-group[data-vcv-guide-helper="save-control"], .vc_navbar-frontend .vc_btn-save, .vc_navbar-frontend .vc_btn-save-draft', function ( e ) {
