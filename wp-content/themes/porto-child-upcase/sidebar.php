...
?>
	<div class="col-lg-3 sidebar <?php echo 'porto-' . $porto_sidebar; ?> <?php echo str_replace('both-', 'left-', str_replace('wide-', '', $porto_layout)); ?><?php echo !$mobile_sidebar ? '' : ' mobile-sidebar'; ?>">
		<!-- main sidebar -->
...
<?php if (in_array($porto_layout, porto_options_both_sidebars())) : ?>
	<div class="<?php echo porto_filter_output($mobile_sidebar ? 'col-md-4 col-lg-3' : 'col-lg-3'); ?> sidebar <?php echo 'porto-' . esc_attr($porto_sidebar); ?> right-sidebar">
		<!-- second sidebar -->
		<?php if ($sticky_sidebar) : ?>
