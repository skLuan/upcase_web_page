...
<div class="footer-bottom">
	<div class="container">
		...
		<div class="footer-left">
			...
			if ( $porto_settings['footer-logo'] && $porto_settings['footer-logo']['url'] ) :
				...
				<span class="d-flex logo">
					<a class="mx-auto mx-lg-0" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?> - <?php bloginfo( 'description' ); ?>">
		...
		<?php if ( ( $porto_settings['footer-payments'] && $porto_settings['footer-payments-image'] && $porto_settings['footer-payments-image']['url'] ) || 'center' == $porto_settings['footer-copyright-pos'] ) : ?>
			<div class="d-flex flex-column d-lg-block <?php echo 'center' == $porto_settings['footer-copyright-pos'] || 'right' == $porto_settings['footer-copyright-pos'] || ( 'left' == $porto_settings['footer-copyright-pos'] && is_registered_sidebar( 'footer-bottom' ) && is_active_sidebar( 'footer-bottom' ) ) ? 'footer-center' : 'footer-right'; ?>">
				...
				if ( 'center' == $porto_settings['footer-copyright-pos'] ) {
					echo '<span class="mx-auto mx-lg-0 footer-copyright">' . wp_kses_post( $porto_settings['footer-copyright'] ) . '</span>';
					dynamic_sidebar( 'footer-bottom' );
				}
				?>
			</div>
