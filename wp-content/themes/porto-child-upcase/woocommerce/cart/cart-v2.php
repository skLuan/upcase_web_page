						...
						<table class="shop_table responsive cart cart-table woocommerce-cart-form__contents" cellspacing="0">
							<thead>
								<tr>
									...
									<th class="product-subtotal text-center text-md-right"><span><?php esc_html_e( 'Sub total', 'woocommerce' ); ?></span></th>
								</tr>
							</thead>
							<tbody>
										...
										<?php if ( wc_coupons_enabled() ) { ?>
											<div class="cart_totals_toggle">
												<div id="panel-cart-discount" class="d-sm-flex justify-content-between">
													<div class="coupon">
														<input type="text" name="coupon_code" class="input-text" id="coupon_code" placeholder="<?php esc_attr_e( 'Cupón de compra', 'woocommerce' ); ?>" value="" />
