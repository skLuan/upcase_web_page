...
<div class="cart_totals<?php echo WC()->customer->has_calculated_shipping() ? ' calculated_shipping' : ''; ?>">
	<div class="cart_totals_toggle">
		<div class="card card-default">
			<h4 class="card-sub-title text-md text-uppercase m-b-md pb-1"><?php esc_html_e( 'Resumen de compra', 'woocommerce' ); ?></h4>
			<div id="panel-cart-total">
				<div class="card-body p-0">
					<table class="responsive cart-total" cellspacing="0">
						<tr class="cart-subtotal">
							<th><h4 class="mb-0"><?php esc_html_e( 'Sub total', 'woocommerce' ); ?></h4></th>
					...
					<div class="wc-proceed-to-checkout">
						<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>" class="btn btn-v-dark w-100 m-t-lg py-3"><?php esc_html_e( 'Pagar', 'woocommerce' ); ?><i class="vc_btn3-icon fas fa-arrow-right ps-3"></i></a>
					</div>
				</div>
			</div>
		</div>
