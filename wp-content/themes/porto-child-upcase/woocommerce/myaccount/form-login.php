...
?>
	<div class="p-0 bg-transparent porto-social-login-section false-modal">
	...
	<div class="align-left <?php echo (true == $lightbox ? esc_html('featured-box') : ''); ?>">
		<div class="box-content">
			...
			<?php if (false === $lightbox && 'yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
				...
				<div class="u-columns col2-set d-lg-flex flex-column" id="customer_login">

					<div class="mx-lg-auto u-column1 col-1">

					<?php endif; ?>
					<form id="login-form" class="woocommerce-form woocommerce-form-login login <?php echo false === $lightbox && 'yes' === get_option('woocommerce_enable_myaccount_registration') ? 'pr-lg-4 pe-0' : ''; ?>" method="post">
						<h3 class="mb-2 account-sub-title font-weight-bold text-capitalize text-v-dark"><?php esc_html_e('Login', 'woocommerce'); ?></h3>
						...
						<p class="mb-2 woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						...
						<div class="mb-4 woocommerce-LostPassword lost_password d-flex flex-column flex-sm-row justify-content-between">
							<div class="my-2 porto-checkbox my-sm-0">
						...
						<p class="pb-1 mb-3 form-row mb-lg-0 pb-lg-0">
							<?php wp_nonce_field('woocommerce-login', 'woocommerce-login-nonce'); ?>
							<button type="submit" class="py-3 woocommerce-Button button login-btn btn-v-dark text-md w-100" name="login" value="<?php esc_attr_e('Login', 'woocommerce'); ?>"><?php esc_html_e('Login', 'woocommerce'); ?></button>
						</p>
						...
						<?php elseif (true == $lightbox && 'yes' === get_option('woocommerce_enable_myaccount_registration')) : ?>
							<p class="mb-0 woocommerce-form-row form-row">
								<?php wp_nonce_field('woocommerce-register', 'woocommerce-register-nonce'); ?>
								<input type="email" class="d-none" name="email" id="email" />
								<button type="submit" class="py-3 bg-transparent border-0 woocommerce-Button button register-btn text-decoration-none text-md font-weight-bold w-100" name="register" value="<?php esc_attr_e('Register', 'woocommerce'); ?>"><?php esc_html_e('Register Now!', 'woocommerce'); ?></button>
							</p>
						<?php endif; ?>
						<?php do_action('woocommerce_login_form_end'); ?>
					</form>
					</div>
					<div id="sigup-form-container" class="u-column2 col-2 mb-3 mx-lg-auto">
						<form id="signup-form" method="post" class="hidden woocommerce-form woocommerce-form-register register pe-0" <?php do_action('woocommerce_register_form_tag'); ?>>
							<h3 class="mb-2 account-sub-title font-weight-bold"><?php esc_html_e('Register', 'woocommerce'); ?></h3>
							<?php do_action('woocommerce_register_form_start'); ?>

							<?php if ('no' === get_option('woocommerce_registration_generate_username')) : ?>

								<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
									<label class="mb-1 font-weight-medium" for="reg_username"><?php esc_html_e('Username', 'woocommerce'); ?>&nbsp;<span class="required">*</span></label>
							...
							<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
								<label class="mb-1 font-weight-medium" for="reg_email"><?php esc_html_e('Email address', 'woocommerce'); ?>&nbsp;<span class="required">*</span></label>
							...
							<?php if ('no' === get_option('woocommerce_registration_generate_password')) : ?>
								...
								<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
									<label class="mb-1 font-weight-medium" for="reg_password"><?php esc_html_e('Password', 'woocommerce'); ?>&nbsp;<span class="required">*</span></label>
							...
							<p class="mb-0 woocommerce-form-row form-row">
								<?php wp_nonce_field('woocommerce-register', 'woocommerce-register-nonce'); ?>
								<button type="submit" class="py-3 woocommerce-Button button register-btn btn-v-dark text-md w-100" name="register" value="<?php esc_attr_e('Register', 'woocommerce'); ?>"><?php esc_html_e('Register', 'woocommerce'); ?></button>
							</p>
					...
					<div class="d-flex mx-lg-auto u-column2 col-2">
						<a href="#login-form" id="btn-login" class="active mx-auto bold"> Iniciar sesión </a>
						<a href="#signup-form" id="btn-signup" class="inactive mx-auto bold"> Crear cuenta </a>
					</div>
				</div>
