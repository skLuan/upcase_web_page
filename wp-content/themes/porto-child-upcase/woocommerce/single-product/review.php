		...
		<div class="comment-text">
			...
			<?php if ( $rating && get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) : ?>
				...
				<div class="star-rating" title="<?php echo esc_attr( $rating ); ?>">
					<span style="width:<?php echo 100 * ( $rating / 5 ); ?>%"><strong><?php echo esc_html( $rating ); ?></strong> <?php esc_html_e( 'de 5', 'porto' ); ?></span>
				</div>
			...
			<?php if ( '0' == $comment->comment_approved ) : ?>
				...
				<p class="meta"><em><?php esc_html_e( 'Tu comentario se está revisando', 'porto' ); ?></em></p>
