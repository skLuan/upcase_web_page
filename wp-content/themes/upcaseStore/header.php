	...
	<div id="page" class="hfeed site">
		...
		<header id="masthead" class="site-header" role="banner" style="">
			...
			<ul class="relative hidden list-none lg:flex-row lg:flex lg:justify-center lg:items-center">
				<li class="px-4"><a class="text-lg font-medium" href="<?php echo home_url() . '/tienda/categoria/fundas/' ?>">Fundas</a></li>
				<li class="px-4"><a class="text-lg font-medium" href="<?php echo home_url() . '/tienda/categoria/colecciones/' ?>">Colección</a></li>
				...
				<li class="px-4"><a class="text-lg font-medium" href="<?php echo home_url() . '/tienda/categoria/stikers/' ?>">Stikers</a></li>
