					...
					'fields'     => array(
						array(
							...
							'desc'    => wp_kses(
								sprintf(
									/* translators: %s: Header builder url */
									__( 'You can add new header layout using <a href="%s" target="_blank">Header Builder</a>.', 'porto' ),
									esc_url(
										admin_url( 'edit.php?post_type=porto_builder&porto_builder_type=header' )
									)
								),
								array(
									'a' => array(
					...
					array(
						...
						'fields'     => array(
							...
							array(
								...
								'desc'    => wp_kses(
									sprintf(
										/* translators: %s: Footer builder url */
										__( 'You can add new footer layout using <a href="%s" target="_blank">Footer Builder</a>.', 'porto' ),
										esc_url(
											admin_url( 'edit.php?post_type=porto_builder&porto_builder_type=footer' )
										)
									),
									array(
										'a' => array(
						...
						array(
							...
							'desc'    => wp_kses(
								sprintf(
									...
									__( 'You can control the blog sidebar and secdonary sidebar in <a href="%s" target="_blank">here</a>.', 'porto' ),
					...
					array(
						...
						'fields'     => array(
							...
							array(
								...
								'default'  => '4',
								'required' => array( 'member-view-type', 'not', 'advanced' ),
							),
							array(
